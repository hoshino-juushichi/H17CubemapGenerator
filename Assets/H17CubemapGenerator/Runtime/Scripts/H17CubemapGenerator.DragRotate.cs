...
namespace Hoshino17
{
	...
	{
		[SerializeField] float _dragSppedScale = 30f;
		[SerializeField] bool _editerDragControl;
		...
		void OnUpdateDragRotate()
		{
			...
			if (_isDragging)
			{
				...
				Vector3 angleDelta = new Vector3(-delta.y, -delta.x, 0f) * _dragSppedScale * Time.deltaTime;
