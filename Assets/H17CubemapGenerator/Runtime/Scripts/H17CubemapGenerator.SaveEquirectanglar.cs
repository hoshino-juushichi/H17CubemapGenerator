	...
	public partial class H17CubemapGenerator : MonoBehaviour, IH17CubemapGenerator
	{
		...
		class SaveAsEquirectanglar : ICubemapSave
		{
			...
			public IEnumerator SaveAsPNGCoroutine(string assetPath)
			{
				...
				var desc = new RenderTextureDescriptor(_generator._textureWidth * 2, _generator._textureWidth, format, 32);
				...
				var tempTex = new Texture2D(tempRT.width, tempRT.height, textureFormat, false);
